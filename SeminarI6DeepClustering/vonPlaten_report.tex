...
\begin{figure}[H]
\begin{center}
	\includegraphics[scale=0.6]{images/piv_train.png}
\end{center}
...
As a conclusion, \emph{TasNet} can be regarded to be more of an \emph{end-to-end} model 
than \emph{deep clustering}. 
